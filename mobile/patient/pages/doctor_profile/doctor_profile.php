        ...
        foreach ($mednet_doctor_data['data'] as $key => $dates_data) {
          ...
          $a = array(
           ...
           $doctor_data = [
            "doc_image"       => $row['doctor_photo'],
            "doc_name"        => $row['DoctorName'],
            "doc_designation" => html_entity_decode($row['CurrentDesignation']),
            "doc_mednet_dept" => html_entity_decode($row['mednet_DepartmentName']),
            "doc_mednet_id"   => $row['mednet_doctor_id'],
            "doc_reg_number"  => $row['RegNumber'],
            "doc_information" => [
                ...
                "education"         => html_entity_decode($row['Education']),
                "experience"        => html_entity_decode($row['WorkExperience']),
                "awards_membership" => html_entity_decode($row['AwardRecognition']),
                "otherinfo"         => html_entity_decode($row['OtherInformation'])
            ],
